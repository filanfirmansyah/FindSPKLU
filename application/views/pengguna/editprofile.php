   <div class="page-title">
          ...
          <div class="row">
			...
			//open form 
			echo form_open(base_url('pengguna/editprofile'),'class="form-horizontal" enctype="multipart/form-data" parsley-validate');
			...
			<div class="col-lg-3">
			<input type="password" name="passbaru" class="form-control" placeholder="Password" value="" autocomplete="off"> * Kosongkan password jika tidak ingin mengganti password.
